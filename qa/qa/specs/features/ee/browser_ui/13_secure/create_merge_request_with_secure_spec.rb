...
module QA
  RSpec.describe 'Secure', :runner do
    describe 'Security Reports in a Merge Request' do
      ...
      it 'displays the Security reports in the merge request', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/351112', type: :investigating }, testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/348031' do
