...
module QA
  RSpec.describe 'Create' do
    describe 'Push over SSH using Git protocol version 2', :requires_git_protocol_v2 do
      ...
      it 'user pushes to the repository', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/352202', type: :investigating }, testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/347734' do
