...
module QA
  RSpec.describe 'Verify', :runner do
    describe 'Include multiple files from a project' do
      ...
      it 'runs the pipeline with composed config', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/358007', type: :investigating }, testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/348087' do
