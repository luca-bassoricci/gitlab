...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `byteEnd` | Int | End index of the section. |
| `byteStart` | Int | Start index of the section. |
| `content` | String | The content of this section. |
| `dateEnd` | Time | Time that the section ended. |
| `dateStart` | Time | Time that the section started. |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `html` | String | The trace as HTML. |
| `raw` | String | The trace as plaintext. |
| `sections` | BuildSection! => Array | The sections in the trace. |
...
| `trace` | BuildTrace | Output of the job |
