...
RSpec.describe ResetSkippedContainerRepositoryImports do
  ...
  describe '#up' do
    it 'resets only qualified container repositories', :aggregate_failures do
      ...
      expect(container_repository3.reload.migration_state).to eq('default')
      expect(container_repository3.migration_skipped_reason).to eq(nil)
