...
RSpec.shared_examples 'project issuable templates' do
  ...
  def templates(issuable_type, inherited_from)
    [
      {
        id: "#{issuable_type}-bar", name: "#{issuable_type}-bar",
        namespace_id: inherited_from.namespace.id, project_id: inherited_from.id,
        namespace_path: inherited_from.namespace.full_path, project_path: inherited_from.path
      },
      {
        id: "#{issuable_type}-foo", name: "#{issuable_type}-foo",
        namespace_id: inherited_from.namespace.id, project_id: inherited_from.id,
        namespace_path: inherited_from.namespace.full_path, project_path: inherited_from.path
      }
    ]
