...
RSpec.describe Gitlab::Database::RenameReservedPathsMigration::V1::RenameBase, :delete do
  ...
  describe '#rename_path_for_routable' do
    context 'for personal namespaces' do
      let(:namespace) { create(:namespace, path: 'the-path') } # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
      ...
      it "doesn't rename routes that start with a similar name" do
        other_namespace = create(:namespace, path: 'the-path-but-not-really') # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
    ...
    context 'for projects' do
      let(:parent) { create(:namespace, path: 'the-parent') } # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
  ...
  describe '#perform_rename' do
    context 'for personal namespaces' do
      it 'renames the path' do
        namespace = create(:namespace, path: 'the-path') # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
