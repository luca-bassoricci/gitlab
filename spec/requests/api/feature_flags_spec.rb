...
RSpec.describe API::FeatureFlags do
  ...
  describe 'GET /projects/:id/feature_flags' do
    ...
    context 'when there are two feature flags' do
      ...
      let!(:strategy) do
        create(:operations_strategy, feature_flag: feature_flag_1, name: 'default', parameters: {})
      end
    ...
    context 'with a single feature flag' do
      let!(:feature_flag) do
  ...
  describe 'GET /projects/:id/feature_flags/:name' do
    ...
    context 'when there is a feature flag' do
      let!(:feature_flag) { create(:operations_feature_flag, project: project, name: 'feature1') }
      let!(:strategy) { create(:operations_strategy, feature_flag: feature_flag, name: 'default', parameters: {}) }
      let!(:scope) { create(:operations_scope, strategy: strategy, environment_scope: 'production') }
