...
RSpec.describe Projects::FeatureFlagsController do
  ...
  describe 'GET #show.json' do
    ...
    it 'returns strategies ordered by id' do
      first_strategy = create(:operations_strategy, feature_flag: feature_flag)
      second_strategy = create(:operations_strategy, feature_flag: feature_flag)
  ...
  describe 'POST create.json' do
    ...
    context 'when creating a feature flag with strategies and scopes' do
      let(:params) do
        {
          namespace_id: project.namespace,
          project_id: project,
  ...
  describe 'PUT update.json' do
    ...
    it 'creates a new strategy and scope' do
      put_request(feature_flag, strategies_attributes: [{
        name: 'userWithId',
        parameters: { userIds: 'user1' },
        scopes_attributes: [{
          environment_scope: 'production'
    ...
    it 'supports switching the associated user list for an existing gitlabUserList strategy' do
      user_list = create(:operations_feature_flag_user_list, project: project, name: 'My List', user_xids: 'user1,user2')
      strategy = create(:operations_strategy, feature_flag: feature_flag, name: 'gitlabUserList', parameters: {}, user_list: user_list)
    ...
    it 'allows setting multiple gitlabUserList strategies to the same user list' do
      ...
      strategy_a = create(:operations_strategy, feature_flag: feature_flag, name: 'gitlabUserList', parameters: {}, user_list: user_list_a)
      strategy_b = create(:operations_strategy, feature_flag: feature_flag, name: 'gitlabUserList', parameters: {}, user_list: user_list_a)
