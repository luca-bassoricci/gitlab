  ...
  describe '#perform' do
    ...
    context 'with exclusive lease' do
      ...
      it 'does not allow same app to be updated concurrently by different project', :aggregate_failures do
        project1 = create(:project, namespace: create(:namespace, owner: user)) # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
      ...
      it 'allows different app to be updated by different project', :aggregate_failures do
        ...
        project2 = create(:project, namespace: create(:namespace, owner: user)) # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
