...
class CreateIssueCustomTypes < ActiveRecord::Migration[6.0]
  ...
  def up
    ...
    IssueCustomType.create(name: 'Enhancement', namespace_id: nil, issue_type: :issue, icon_name: 'issue-type-enhancement')
    IssueCustomType.create(name: 'Feature', namespace_id: nil, issue_type: :issue, icon_name: 'issue-type-feature')
    IssueCustomType.create(name: 'Tech Debt', namespace_id: nil, issue_type: :issue, icon_name: 'issue-type-maintenance')
  end
