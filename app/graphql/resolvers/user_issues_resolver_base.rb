...
module Resolvers
  class UserIssuesResolverBase < IssuesResolver
    ...
    argument :project_path,
             ...
             required: false,
             description: <<~DESC
               The full-path of the project the authored issues should be in.
    ...
    argument :project_id,
             ...
             required: false,
             description: <<~DESC
               The global ID of the project the authored issues should be in.
    ...
    def can_read_project?
      Ability.allowed?(current_user, :read_issue, project)
    end
