    ...
    module BaseService
      ...
      def assign_epic(issue, epic)
        ...
        EpicIssues::CreateService.new(epic, current_user, link_params).execute.tap do |result|
          ...
          if had_epic
            ::Gitlab::UsageDataCounters::IssueActivityUniqueCounter.track_issue_changed_epic_action(author: current_user, project: issue.project)
          else
            ::Gitlab::UsageDataCounters::IssueActivityUniqueCounter.track_issue_added_to_epic_action(author: current_user, project: issue.project)
          end
        end
      end
