...
module EE
  ...
  module User
    ...
    def authorized_groups(with_minimal_access: true, selector: nil)
      return super(selector: selector) unless with_minimal_access

      ::Group.unscoped do
        ::Group.from_union([
          super(selector: selector),
          available_minimal_access_groups.reselect(selector)
        ])
      end
    end
