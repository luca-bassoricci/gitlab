      ...
      context 'with an authenticated developer' do
        ...
        context 'with a project in the dashboard' do
          ...
          it 'does not return a project for which the operations dashboard feature is unavailable' do
            ...
            namespace = create(:namespace, visibility_level: PRIVATE) # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
          ...
          it 'returns seven projects when some projects do not have the dashboard feature available' do
            ...
            public_namespace = create(:namespace, visibility_level: PUBLIC) # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
            ...
            private_namespace = create(:namespace, visibility_level: PRIVATE) # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
