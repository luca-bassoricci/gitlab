...
RSpec.describe GitlabSubscriptions::UpcomingReconciliation do
  ...
  describe 'scopes' do
    let_it_be(:namespace1) { create(:namespace) } # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
    let_it_be(:namespace2) { create(:namespace) } # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
    let_it_be(:namespace3) { create(:namespace) } # rubocop:disable RSpec/ProhibitNamespaceFactoryUsage
