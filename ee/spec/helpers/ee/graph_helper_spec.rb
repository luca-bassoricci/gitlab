...
RSpec.describe EE::GraphHelper do
  describe '#should_render_deployment_frequency_charts' do
    ...
    before do
      stub_licensed_features(cd_dora_analytics: is_feature_licensed)
      ...
      allow(self).to receive(:can?).with(current_user, :read_cd_dora_analytics, project).and_return(is_user_authorized)
    end
